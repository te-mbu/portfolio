        ...
        <div className="flex items-center justify-between gap-4 w-full h-full lg:flex-col">
          ...
          <div className="w-1/2 flex flex-col items-center self-center lg:w-full">
            ...
            <p className="my-4 text-base font-medium md:text-md sm:text-sm md:my-8">
              I&apos;m a France based Fullstack Web Developer dedicated to
              turning ideas into innovative, clean & user-friendly web
              applications. Explore my latest projects showcasing my expertise
